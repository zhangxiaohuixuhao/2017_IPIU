...
tf.app.flags.DEFINE_string('test_data_path', '/home/asdf/Documents/zhanghui/refinenet-image-segmentation-master/RefineNet/teat_data', '')
...
tf.app.flags.DEFINE_string('result_path', '/home/asdf/Documents/zhanghui/refinenet-image-segmentation-master/RefineNet/result5/', '')
...
def resize_image(im, size=32, max_side_len=3000):
    h, w, _ = im.shape
    resize_w = w
    resize_h = h
...
def main(argv=None):
    ...
    with tf.get_default_graph().as_default():
        ...
        logits = model.model(input_images, FLAGS.num_classes, is_training=False)
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for im_fn in im_fn_list:
                ...
                cv2.imwrite(os.path.join(FLAGS.result_path, os.path.basename(im_fn)), pred_re)
